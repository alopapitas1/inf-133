...
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///zoo.db"#sienmpre sera lo msimo las 2 lineas por defecto 
app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False

# Inicializa la base de datos
db.init_app(app)#inicalizamos cuando se levanta el servidor la base de datos,

# Registra el blueprint de animales en la aplicación
app.register_blueprint(animal_bp, url_prefix="/api")#los bluprints son la forma en la que se resuelven las rutas
#registramos el rever y el rpefijo api
