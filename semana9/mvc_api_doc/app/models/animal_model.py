...
class Animal(db.Model):
    ...
    def update(self, name=None, species=None, age=None):#verifico con lo que tenga y hago el update
        if name is not None:
            self.name = name
    ...
    def delete(self):#
        db.session.delete(self)#borrar
        db.session.commit()#concretar la accion anterior
